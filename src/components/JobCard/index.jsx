...
const JobCard = ({ job }) => {
  ...
  return (
    <div
      ...
      flex flex-col items-center justify-between gap-5 py-4 px-4 "
    >
        ...
        <div className="w-full flex flex-col gap-[6px] items-start">
          ...
          <div className="flex items-center gap-2 mt-2 bg-white">
            {job.entrada_imediata === "0" ? (
              <span className="text-[11px] px-2 py-1 font-regular  bg-gradient-to-r from-yellow-500  to-yellow-600 inline-block text-transparent bg-clip-text">
      ...
      <div className="flex justify-between gap-4 w-full">
        <button
          ...
          className="text-white font-medium text-[12px] rounded-md border border-1 border-white w-full h-10 p-1"
        >
          Saber Mais
        </button>
      </div>
